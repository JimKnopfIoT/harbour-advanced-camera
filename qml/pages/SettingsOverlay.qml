            ...
            SilicaFlickable {
                ...
                Column {
                    ...
                    Slider {
                        ...
                        SliderMarks {
                            ...
                            recommendedValue: {
                                ...
                                var bits = r.width * r.height * 30 * 0.065
                                return Math.min(sldVideoBitrate.maximumValue, Math.max(sldVideoBitrate.minimumValue,
                                                Math.round(bits / sldVideoBitrate.stepSize) * sldVideoBitrate.stepSize))
                            }
                        }
                    }
                    Slider {
                    ...
                    TextSwitch {
                        ...
                        text: qsTr("Show histogram (experimental)")
